...
class Method:
    ...
    """
    required_attrs = ()
    def __init__(self, data, progress=None, logname="Log"):
...
class Electrons(Method):
    ...
    def __init__(self, data, progress=None, logname="Log"):
        ...
        super(Electrons, self).__init__(data, progress, logname)
...
class Orbitals(Method):
    ...
    def __init__(self, data, progress=None, logname="Log"):
        ...
        super(Orbitals, self).__init__(data, progress, logname)
...
class ccData:
    ...
    Description of cclib attributes:
        ...
        dispersionenergies -- a molecular dispersion energy corrections (array[1], hartree)
    ...
    _attributes = {
       ...
       "nalpha":           Attribute(int,              'number of alpha electrons',   'properties'),
       "nbeta":            Attribute(int,              'number of beta electrons',    'properties'),
       ...
       "user_input":       Attribute(dict,             'rem section with user input', 'user_input'),
       ...
       "zpe":              Attribute(float,            'zero-point correction',       'properties:energies')
    }
    ...
    @property
    def closed_shell(self):
        return Orbitals(self).closed_shell()
